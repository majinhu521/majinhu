...
public class DistributedLockTest {
    ...
    private static void simpleDistributedLockImplTest() {
        ...
        final MyZkClient zkClientOne = new MyZkClient("localhost:2181", 5000, 5000, new BytesPushThroughSerializer());
        final SimpleDistributedLockImpl sdliOne = new SimpleDistributedLockImpl(zkClientOne, "/lock/aaa");

        final MyZkClient zkClientTwo = new MyZkClient("localhost:2181", 5000, 5000, new BytesPushThroughSerializer());
        final SimpleDistributedLockImpl sdliTwo = new SimpleDistributedLockImpl(zkClientTwo, "/lock/aaa");
    ...
    private static void distributedLockImplTest() {
        // 分别创建两个客户端，并获取两个SimpleDistributedLockImpl实例
        final MyZkClient zkClientOne = new MyZkClient("localhost:2181", 5000, 5000, new BytesPushThroughSerializer());
        final DistributedLockImpl dliOne = new DistributedLockImpl(zkClientOne, "/lock/aaa");

        final MyZkClient zkClientTwo = new MyZkClient("localhost:2181", 5000, 5000, new BytesPushThroughSerializer());
        final DistributedLockImpl dliTwo = new DistributedLockImpl(zkClientTwo, "/lock/aaa");
        try {
