...
public class HttpClientUtilPool {
    private static Logger logger = LoggerFactory.getLogger(HttpClientUtilPool.class);
    ...
    public static String doPost(String uri, Map<String, String> param) {
        ...
        try {
            ...
            if (param != null)
            {
                ...
                final String param2 = EntityUtils
                        .toString(new UrlEncodedFormEntity(paramList, "utf-8"));
                method.setURI(new URI(method.getURI().toString() + "?" + param2));
